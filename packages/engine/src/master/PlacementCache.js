...
// LeaderboardCache: место игрока меняется медленно, а запрос за ним тяжелее
// топа — это оконная функция по всему леджеру. Один вход участника стоит
// трёх срезов (day/month/all), а хостов у популярной игры сотни.
//
