...
// env читается всегда: домен, порт, адрес auth-сервиса и корень хранилища
// пакетов приходят от деплоя. Каталога игр среди них нет — его задаёт реестр
// auth-сервиса. Остальные переопределения защищены собственными проверками и
