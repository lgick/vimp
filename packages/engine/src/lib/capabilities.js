...
export const ENGINE_CAPABILITIES = createRegistry('engine-capabilities', [
  ...
  // многоуровневые карты: уровней до MAX_LEVELS = 8 (бит на уровень),
  // рампы через несколько уровней, правила уровня и падение у тел карты,
  // `z`/`level` в строке динамики, `volumes` (высота рендер-слоя)
  { value: 'map.levelsN', since: '0.31.0' },
  // высота уровня карты в мировых единицах (`levelHeight`): безразмерный
