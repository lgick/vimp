...
class Participant {
  constructor({ gameId, name, model, team, teamId }) {
    ...
    // цвет ника в чате ('#rrggbb') или null — тогда ник красит класс команды.
    // Ставит его игра (ParticipantManager.setChatColor): движок не знает, чем
    // игра различает игроков визуально, а команда для этого годится не всегда
    // — в игре на одну команду все ники одного цвета
    this.chatColor = null;
