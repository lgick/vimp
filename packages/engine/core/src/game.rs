...
mod tests {
    ...
    // слоёная карта 8×8: плита уровня 1 в середине. Внешние торцы плиты —
    // перила (тайл 8): открытый край без земли под ним валидатор отвергает
    fn layered_map_json() -> &'static str {
        r#"{
            ...
            "levels": {
                "1": {
                    "map": [[0, 0, 0, 0, 0, 0, 0, 0], [0, 8, 8, 8, 8, 8, 8, 0], [0, 8, 9, 9, 9, 9, 8, 0], [0, 8, 9, 9, 9, 9, 8, 0], [0, 8, 9, 9, 9, 9, 8, 0], [0, 8, 9, 9, 9, 9, 8, 0], [0, 8, 8, 8, 8, 8, 8, 0], [0, 0, 0, 0, 0, 0, 0, 0]],
                    "floor": [9, 8],
                    "walls": [8]
                }
            }
