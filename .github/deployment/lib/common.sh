...
# нельзя: расхождение генерации Nginx-конфига между двумя сценариями
# обнаружится только в проде. validate_origin и check_auth_placeholder
# сейчас нужны только add-server.sh.
# ====================================================
