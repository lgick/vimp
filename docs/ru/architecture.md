...
Клиент строится вокруг трёх механизмов сглаживания сети; все три живут в клиентском ядре — WASM-классе `ClientCore` того же Rust-бинаря (подробно — [client.md](client.md), ABI — [core.md](core.md#rust-трейты-vimp-engine-core)):
