# Этап 7. Документация и релизная гигиена
...
- [ ] `docs/en/scaffolding.md` и `docs/ru/scaffolding.md` совпадают по
      структуре, обе прописаны в ToC.
- [ ] Корневой `CLAUDE.md` обновлён и укладывается в лимит.
- [ ] Оба CHANGELOG заполнены, уровень релиза читается с подзаголовка.
- [ ] `npx eslint . && npm test` зелёные, `npm run core:test` зелёный.
