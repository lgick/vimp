# Этап 1. `vimp-contract` — валидатор контракта в движке
...
- [ ] `vimp-contract --game packages/engine/tests/fixtures/miniGame` — без `fail`.
- [ ] На tanks зелено, на street-fighters пойманы известные отклонения.
- [ ] Обе страницы `debugging.md` обновлены, CHANGELOG заполнен.
