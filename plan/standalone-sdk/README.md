...
| 6 | [Доработки в репозитории игры (`vimp-tanks`)](stage_6.md) | ✅ выполнен (тайлы карт в standalone отложены отдельной задачей) |
...
задела мастер с auth-сервисом. Этап R4 — четвёртый раунд: блокеров нет,
главное — регрессия в тест-страховке каркаса (R4-1) и петля перезагрузок,
закрытая на двух кодах закрытия из четырёх (R4-2).
