...
| # | Этап | Статус |
| --- | --- | --- |
| 1 | [Изоморфная порт-машина хоста + стратегии идентичности](stage_1.md) | не начат |
| 2 | [Клиентские режимы загрузки, DOM-каркас, WebSocketTransport](stage_2.md) | не начат |
| 3 | [Публикуемый Standalone SDK (`vimp-engine/standalone`)](stage_3.md) | не начат |
| 4 | [Dedicated Node.js сервер](stage_4.md) | не начат |
| 5 | [Деплой, CI, конфигурация, документация](stage_5.md) | не начат |
...
публикации движка после 3 (или `npm link`).
